        ...
        >
          ...
          <input type="hidden" name="form-name" value="contact" />
            ...
            <div className="flex flex-wrap justify-between">
              <label className="flex flex-1 m-1 relative"><span className="hidden">Name</span>
              ...
              <label className="flex flex-1 m-1 relative"><span className="hidden">Email</span>
              ...
              <label className="flex flex-1 m-1 relative"><span className="hidden">Telephone</span>
